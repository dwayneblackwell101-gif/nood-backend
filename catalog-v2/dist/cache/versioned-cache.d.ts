...
export declare class VersionedCache implements ICache {
    private baseCache;
    private config;
    ...
    private getVersionedProducts;
    private getVersionedCollections;
    private getVersionMeta;
    private setVersionMeta;
    private setVersionValidation;
    private getVersionValidation;
    private getActiveVersionIdInternal;
    private setActiveVersionIdInternal;
    private getPreviousVersionId;
    private getVersionListInternal;
}
//# sourceMappingURL=versioned-cache.d.ts.map