      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.sheet}>
          <LinearGradient colors={['#141414', '#0a0a0a']} style={styles.sheetGradient}>
            ...
            <Text style={styles.title}>Scratch Prize</Text>
            <Text style={styles.copy}>You have a Scratch Token. Reveal your NOOD reward.</Text>

            <TouchableOpacity style={styles.primaryButton} activeOpacity={0.9} onPress={onPlayNow}>
